...
export default function GoogleAnalytics() {
  ...
  if (GOOGLE_ADS_ID) {
    ...
    if (GADS_CALL_LABEL) {
      ...
      // CTA bands, footer). The TOP BAR and the HEADER NAV both display
      // the toll-free number (siteConfig.tollFreePhone) — that needs its
      // OWN call-conversion action + label from the ads team before its
      // calls are tracked.
